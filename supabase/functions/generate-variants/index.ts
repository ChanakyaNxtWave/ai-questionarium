...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `**Objective**: As a technical instructional designer with over 10 years of experience, your task is to generate variant questions from a given base question.
